...
1. `AGENT.core.md` + `WORKFLOW.slim.md`（核心运行规则）
2. `START.md` / `PROMPTS/_common.md` / `PROMPTS/bootstrap.md`
3. phase-cards 与（如需）任务 addon
4. 同步完整 `AGENT.md` / `WORKFLOW.md`（详细参考规则，不得覆盖核心运行规则）
...
- [ ] `node .ai/tests/workflow-traces.mjs` 5 条核心轨迹通过
